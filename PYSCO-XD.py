...
\x1b[38;5;46m______________________________________________________
 ...
 \033[1;31m[\033[1;32m[X]\033[1;31m]\033[1;32m [+] TOOLS     : RANDOM
...
def admin():
	...
	if bal =='2':
		...
		admin()
	if bal =='3':
		os.system('xdg-open https://github.com/PYSCO-XD2');time.sleep(1)
		admin()
	if bal =='0':
		Main()
...
def b(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;90m[\033[1;93m[FARHAN]\033[1;90m] \033[1;96m%s/%s\033[1;90m \033[1;90m[\033[1;92mOK:%s\033[1;90m] '%(loop,tl,len(oks))),
            sys.stdout.flush()
...
def superuser():
    ...
    id = "5".join(uuid)
    print(logo)
    DARK=requests.get("https://raw.githubusercontent.com/PYSCO-XD2/PYSCO/main/approval.txt").text
    if id in DARK:
        Main()
    else:
        os.system("clear")
        os.system("xdg-open https://https://github.com/PYSCO-XD2")
        time.sleep(3.0)
        os.system("
        print(logo)
        ...
        print ("\n")
        os.system("espeak \"assalamualaikum ,I am ALEX FARHAN x JOBAID er  ROBOT and my boss is FARHAN x JOBAID.Sir this tool is paid because 100% ok id just now login\"")
        name = input(" Your Name : ")
        os.system(f"espeak \"{name} ,prass Enter to send your key\"")
        print ("")
        input(" Press Enter To Send Key")
        os.system("xdg-open https://wa.me/+8801843961233")
        superuser()        
superuser()
